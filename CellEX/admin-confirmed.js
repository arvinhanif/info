(function(){
    const KEY = 'confirmedOrders';
    const el = document.getElementById('confirmed');
    const empty = document.getElementById('emptyConf');
      ...
      list.forEach(o=>{
        ...
        div.innerHTML = `
          ...
          <div class="order-main">
            ...
            <div class="order-time">Placed: ${new Date(o.createdAt).toLocaleString()} · Confirmed: ${new Date(o.handledAt).toLocaleString()}</div>
          </div>
    ...
    function remove(id){
      if (!confirm('Delete this confirmed order permanently?')) return;
      let list = read();
